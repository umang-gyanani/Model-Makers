...
function Talents() {
  return (
    <>
      <section className="aboutWhat_bg">
                ...
                <div className="relative">
                  ...
                  <div className="bg-[#18314F] absolute backdrop-blur-md rounded-t-[4px] rounded-bl-[4px] rounded-br-[20px] w-[98%] p-[17px_10px_18px_13px] bottom-3 left-2/4 -translate-x-2/4">
                    ...
                    <div className="flex items-center flex-wrap gap-[10px] mt-2.5">
                      <p className="text-normal text-[18px] text-[#B8CAD4] xl:border-r-2 border-[#008CCF] lg:pe-[10px]">
                        Height-
                        <span className="text-white ">{v.Height}</span>
                      </p>
                      <p className="text-normal text-[18px] text-[#B8CAD4] lg:px-[10px] sm:px-[5px] px-[10px]">
                        Shoes-
                        <span className="text-white ">{v.Shoes}</span>
                      </p>
                      <p className="text-normal text-[18px] text-[#B8CAD4] xl:border-x-2 border-[#008CCF] lg:px-[10px] sm:px-[5px]  ">
                        {" "}
                        Hair-
                        <span className="text-white ">{v.Hair}</span>
                      </p>
                      <p className="text-normal text-[18px] text-[#B8CAD4]  sm:px-0 px-[10px]">
                        {" "}
                        Eyes-
