    ...
    <>
            ...
            {ReviewData.map((v, i) => {
              return (
                ...
                >
                  ...
                  <p className="font-normal text-[18px] text-[#4C4E55] md:text-center">
                    {v.Discription}
                  </p>
                </div>
              );
        ...
        <div className="container max-w-[1140px] m-auto px-3">
          <div className="flex flex-col gap-y-10 md:flex-row items-center">
            ...
            >
              ...
              <p className="font-normal text-[18px] text-[#4C4E55] pb-[29px] pt-[10px]">
      ...
      <section className="marketing_bg overflow-hidden">
        <div className="py-[40px] md:pt-[87px] md:pb-[106px]">
          <div className="container max-w-[1140px] m-auto px-3">
            <p className="uppercase font-bold text-[28px] sm:text-[36px] lg:text-[44px] text-white">
              your <span className="capitalize font-normal">Ultimate</span>{" "}
              Marketing Partner{" "}
            </p>
            <div className="flex flex-row">
              <div className="w-full md:w-10/12 lg:w-6/12">
                {[
                  ...
                  >
                    <p className="font-bold text-xl sm:text-[24px] text-white uppercase">
                      {service.title}
                    </p>
                    <p className="font-normal text-base sm:text-[18px] text-[#C3C0BF] pt-[8px] leading-[150%]">
                      {service.desc}
                    </p>
                  </div>
                ))}
          ...
          <div className="container max-w-[1140px] m-auto px-3 relative z-30">
            <div className="md:pt-[147px] md:pb-[103px] py-[40px]">
              ...
              >
                ...
                <p className="font-bold text-xl md:text-[24px] text-white">
      ...
      <section className="talent_bg overflow-hidden">
        ...
        <div className="pt-[50px] md:pt-[80px] lg:pt-[162px]">
          ...
          >
            <p className="font-bold text-[28px] sm:text-[36px] lg:text-[44px] uppercase">
              our{" "}
              <span className="font-normal text-[#20B8F1] capitalize">
                successful
              </span>{" "}
              talents
            </p>
        ...
        >
          <Slider {...settings} className="pt-[49px] pb-[32px]">
            {TalentCardData.map((v, i) => (
              <div key={i} className="relative group px-3 overflow-hidden">
                <img
                  src={v.image}
                  alt={v.image}
        ...
        <div className="py-[50px] md:pt-[90px] lg:pt-[168px] lg:pb-[164px]">
          <div className="container max-w-[1140px] m-auto px-3">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-[60px]">
              ...
              >
                <p className="font-bold text-[28px] sm:text-[36px] mx-auto lg:text-[44px] uppercase leading-[118%] pb-[10px]">
                  Only Fans{" "}
                  <span className="font-normal text-[#20B8F1] capitalize">
                    isn't a walk
                  </span>{" "}
                ...
                <p className="font-normal text-base sm:text-[18px] text-[#4C4E55] leading-[145%]">
                ...
                <p className="font-normal text-base sm:text-[18px] text-[#4C4E55] pt-[10px] leading-[145%]">
      ...
      <section className="Timeline_bg lg:pe-3  overflow-hidden">
        <div className="grid gap-10 sm:gap-20 items-center grid-cols-1 lg:grid-cols-2">
          ...
          >
            <p className="font-bold text-[28px] sm:text-[36px] lg:text-[44px] text-white uppercase">
              what makes us{" "}
              <span className="font-normal capitalize">special</span>?
            </p>
      ...
      <section className="OurTeam_bg overflow-hidden">
        <div className="py-[60px] md:pt-[169px] md:pb-[114px]">
          {/* Heading */}
          <p
            className="font-bold text-[28px] sm:text-[36px] lg:text-[44px] uppercase text-center"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            latest{" "}
            <span className="font-normal text-[#00AFEF] capitalize">from</span>{" "}
            our team
          </p>
          ...
          <div className="container max-w-[1140px] m-auto px-3">
            <div className="flex flex-row flex-wrap gap-y-10 -mx-3 pt-[38px] pb-[46px]">
              ...
              <div
                ...
                data-aos-delay="100"
              >
                <div className="bg-white border border-white group">
                  <div className=" overflow-hidden rounded-tr-[20px] rounded-tl-[20px]">
                    <img
                      width="100%"
                      src={SkyRocketImag}
                      alt="sky"
                      className="rounded-tl-[20px] group-hover:scale-150 duration-500 rounded-tr-[20px]"
                    />
                  </div>
                ...
                <div className="bg-white border border-white group">
                  <div className=" overflow-hidden rounded-tl-[20px] rounded-tr-[20px]">
                    <img
                      ...
                      src={EarningImg}
                      alt="sky"
                      className="rounded-tl-[20px] rounded-tr-[20px] group-hover:scale-150 duration-500"
                    />
                  </div>
                  <p className="font-bold text-lg md:text-xl xl:text-[24px] uppercase pt-[27px] pb-[24px]">
